...
<<<<<<< HEAD
 * Generated at: 2019-08-15 05:21:49 UTC
=======
 * Generated at: 2019-08-16 08:33:23 UTC
...
public final class missingView_jsp extends org.apache.jasper.runtime.HttpJspBase
...
<<<<<<< HEAD
    _jspx_dependants.put("/WEB-INF/views/common/header.jsp", Long.valueOf(1565846454530L));
=======
...
if(memberLoggedIn!=null && "admin".equals(memberLoggedIn.getMemberId())){ 
 ...
 if(memberLoggedIn != null){
      ...
      out.print(request.getContextPath());
      out.write("/board/missingCommentInsert' method='post'>\";\r\n");
      ...
      out.write("        location.href=\"");
      out.print(request.getContextPath());
      out.write("/board/missingCommentDelete?missingNo=");
      out.print(b.getMissingNo() );
      ...
      out.write(" <br />\r\n");
      out.write("\t\t\t잃어버린장소:");
      out.print(b.getMissingHpPlace() );
      out.write(" <br />\r\n");
      out.write("\t\t\t잃어버린 날짜:");
      out.print(b.getMissingHpDate() );
      out.write(" <br />\r\n");
      out.write("\t\t\t동물종류:");
      out.print(b.getMissingKind() );
      out.write(" <br />\r\n");
      out.write("\t\t\t사례금:");
      out.print(b.getMissingMoney() ==-1?"사례금협의":b.getMissingMoney() == 0?"사례금없음":b.getMissingMoney()+"만원");
      out.write(" <br />\r\n");
      out.write("\t\t\t상세설명:");
      out.print(b.getMissingContent() );
      out.write(" <br />\r\n");
      out.write("\t\t\t게시일:");
      out.print(b.getMissingEnrollDate() );
      out.write(" <br />\r\n");
      out.write("\t\t\t조회수:");
      out.print(b.getMissingCount() );
      out.write(" <br />\r\n");
      out.write("\t\t\t신고수:");
      out.print(b.getMissingReportCount() );
      out.write(" <br />\r\n");
      out.write("\t\t\t신고사유:");
      out.print(b.getMissingReportReason() );
      out.write(" <br />\r\n");
      out.write("\t\t\t첨부파일:\r\n");
      out.write("\t\t\t\r\n");
...
if(b.getMissingOriginalImg()!=null) {
 ...
 if(memberLoggedIn!=null && 
      ...
      out.write("\t\t\t\t<input type=\"button\" value=\"신고하기\" \r\n");
      out.write("\t\t\t\t\t   onclick=\"goMissingViewReportOpen();\"\t />\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\r\n");
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/missingDelete\"\r\n");
      ...
      out.print(b.getMissingNo());
      out.write("\" />\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"renamedFileName\" \r\n");
      out.write("\t\t\t\t   value=\"");
      out.print(b.getMissingRenamedImg()!=null?
      ...
      out.write("\t\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/missingUpdateForm?missingNo=");
      out.print(b.getMissingNo());
      out.write("\"\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/missingCommentInsert\"\r\n");
...
if(memberLoggedIn!=null 
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function goMissingViewReportOpen(){\r\n");
      out.write("\t\r\n");
      out.write("\tvar url = \"");
      out.print(request.getContextPath());
      out.write("/board/missing/missingReport?missingNo=");
      out.print(b.getMissingNo());
      out.write("\";\r\n");
      out.write("    var target = \"new\";\r\n");
      out.write("    var option = \"top=200, left=450, width=450, height=300\";\r\n");
      out.write("   /*  var status =  \"left=500px, top=200px, width=400px, height=500px\"; */\r\n");
      out.write("    \r\n");
