...
@WebServlet("/board/community/free/freeUpdateEnd")
public class FreeUpdateEndServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int freeNo = Integer.parseInt(mReq.getParameter("freeNo"));
		...
		freeContent = freeContent.replaceAll("<", "&lt;").replaceAll(">", "&gt;");
		...
		if(result > 0){
			msg = "게시글 수정 성공!";
			loc = "/board/community/free/freeView?freeNo="+freeNo;
		}
		else {
			msg = "게시글 수정 실패!";				
		}
