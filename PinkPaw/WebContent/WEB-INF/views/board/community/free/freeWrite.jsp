...
<div id="img-div">
	...
	<div id="blackbg"></div>
	<span class="header-title">자유 게시판 글쓰기</span>
</div>
	...
	<form
		...
		<table id="tbl-write" class="table">
			...
			<tr>
				...
				<td><input type="text" name="freeTitle" class="form-control title" required placeholder="한글 20자까지 작성가능"/></td>
			</tr>

			<tr>
				<th class="text-left">작성자<i class="ico-star">*</i></th>
				<td>
					<input type="text" name="freeWriter" value="<%=memberLoggedIn.getMemberId()%>" class="form-control writer" required readonly/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="freeContent" cols="40" rows="5" class="form-control" required></textarea>
				</td>
			</tr>

			<tr>
				<td colspan="2">
					<input type="submit" value="등록" class="btn btn-pink" onclick="return freeBoardValidate();" />
					<input type="button" value="취소" class="btn btn-gray" onclick="return freeBoardWriteCancel();" />
				</td>
			</tr>
