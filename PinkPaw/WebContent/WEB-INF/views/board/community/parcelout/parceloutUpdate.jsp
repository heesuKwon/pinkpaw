	...
	<form action="<%=request.getContextPath()%>/board/parceloutboard/parceloutUpdateEnd"
		...
		<table id="tbl-write" class="table">
			<tr>
				...
				<td><input type="text" name="parceloutTitle" class="form-control title" value="<%=p.getParceloutTitle() %>" required/></td>
			</tr>		
			<tr>
			...
			<tr>
				...
				<td>
					<textarea name="parceloutContent" 
							  cols="40" rows="5" class="form-control" required><%=p.getParceloutContent() %></textarea>
				</td>
			</tr>
...
function goView() {
	location.href="<%=request.getContextPath()%>/board/parcelout/parceloutView?parceloutNo=<%=p.getParceloutNo()%>";
}
