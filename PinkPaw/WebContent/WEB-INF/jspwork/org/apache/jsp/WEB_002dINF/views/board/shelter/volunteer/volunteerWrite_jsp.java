 ...
 * Generated at: 2019-08-17 05:29:41 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.board.shelter.volunteer;
...
public final class volunteerWrite_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(memberLoggedIn!=null && "admin".equals(memberLoggedIn.getMemberId())){ 
      ...
      out.write("\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerWriteEnd\"\r\n");
      out.write("\t\tmethod=\"post\"\r\n");
      ...
      out.write("\t\t\t\t<th>제목</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"volunteerTitle\" required></input>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>작성자</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"volunteerWriter\" value=\"");
      out.print(memberLoggedIn.getMemberId());
      out.write("\"\r\n");
      ...
      out.write("\t\t\t\t<th>내용</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<textarea name=\"volunteerContent\" \r\n");
      out.write("\t\t\t\t\t\t\tcols=\"60\" rows=\"12\" required>단체 및 시설이름 : \r\n");
      out.write("\r\n");
      out.write("주소 : \r\n");
      out.write("\r\n");
      out.write("담당자 이름 :\r\n");
      ...
      out.write("            var pvolunteer = document.getElementById(View_area); //div id\r\n");
      ...
      out.write("        try {\r\n");
      out.write("            var src = document.selection.createRange().text; // get file full path(IE9, IE10에서 사용 불가)\r\n");
      out.write("            var ie_pvolunteer_error = document.getElementById(\"ie_pvolunteer_error_\" + View_area);\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("            if (ie_pvolunteer_error) {\r\n");
      out.write("                pvolunteer.removeChild(ie_pvolunteer_error); //error가 있으면 delete\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            var img = document.getElementById(View_area); //이미지가 뿌려질 곳\r\n");
      out.write("\r\n");
      ...
      out.write("            img.style.filter = \"progid:DXImageTransform.Microsoft.AlphaImageLoader(src='\"+src+\"', sizingMethod='scale')\";\r\n");
      out.write("        } catch (e) {\r\n");
      out.write("            if (!document.getElementById(\"ie_pvolunteer_error_\" + View_area)) {\r\n");
      out.write("                var info = document.createElement(\"<p>\");\r\n");
      out.write("                info.id = \"ie_pvolunteer_error_\" + View_area;\r\n");
      out.write("                info.innerHTML = e.name;\r\n");
      out.write("                pvolunteer.insertBefore(info, null);\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("  //ie가 아닐때(크롬, 사파리, FF)\r\n");
      out.write("    } else {\r\n");
      ...
      out.write("            if (!file.type.match(imageType)){\r\n");
      out.write("                pvolunteer.removeChild(prevImg);\r\n");
      out.write("                continue;\r\n");
      out.write("                }\r\n");
      ...
      out.write("            img.style.width = '100px'; \r\n");
      out.write("            img.style.height = '100px';\r\n");
      out.write("            pvolunteer.appendChild(img);\r\n");
      out.write("            if (window.FileReader) { // FireFox, Chrome, Opera 확인.\r\n");
      out.write("                var reader = new FileReader();\r\n");
      out.write("                reader.onloadend = (function(aImg) {\r\n");
      out.write("                    return function(e) {\r\n");
      ...
      out.write("            } else { // safari is not supported FileReader\r\n");
      out.write("                //alert('not supported FileReader');\r\n");
      out.write("                if (!document.getElementById(\"sfr_pvolunteer_error_\"\r\n");
      out.write("                        + View_area)) {\r\n");
      out.write("                    var info = document.createElement(\"p\");\r\n");
      out.write("                    info.id = \"sfr_pvolunteer_error_\" + View_area;\r\n");
      out.write("                    info.innerHTML = \"not supported FileReader\";\r\n");
      out.write("                    pvolunteer.insertBefore(info, null);\r\n");
      out.write("                }\r\n");
      out.write("            }\r\n");
