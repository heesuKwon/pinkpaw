 ...
 * Generated at: 2019-08-17 16:08:31 UTC
...
public final class volunteerView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.pinkpaw.board.volunteer.model.vo.VolunteerBoard");
  }
...
if(memberLoggedIn!=null && "admin".equals(memberLoggedIn.getMemberId())){ 
 ...
 if(memberLoggedIn != null){
      ...
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerBoardCommentInsert' method='post'>\";\r\n");
      out.write("\t\t\thtml += \"<div class='input-group'>\";\r\n");
      out.write("\t\t\thtml += \"<input type= 'hidden' name='boardRef' value='");
      out.print(volunteerBoard.getVolunteerNo());
      out.write("'/>\";\r\n");
      ...
      out.write("\t\t\t\t.children(\"form\").slideDown(800)\r\n");
      out.write("\t\t\t\t.children(\"form\").submit((e)=>{\r\n");
      ...
      out.write("\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerBoardCommentDelete\"\r\n");
      ...
      out.write("\t\t\t<th>제목</th>\r\n");
      out.write("\t\t\t<td>");
      out.print(volunteerBoard.getVolunteerTitle() );
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>작성자</th>\r\n");
      out.write("\t\t\t<td>");
      out.print(volunteerBoard.getVolunteerWriter() );
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>조회수</th>\r\n");
      out.write("\t\t\t<td>");
      out.print(volunteerBoard.getVolunteerCount() );
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>게시일</th>\r\n");
      out.write("\t\t\t<td>");
      out.print(volunteerBoard.getVolunteerEnrolldate() );
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
...
if(volunteerBoard.getVolunteerOriginalImg()!=null) {
      ...
      out.write("\t\t\t\t<img src=\"");
      out.print(request.getContextPath());
      out.write("/upload/board/volunteer/");
      ...
      out.write("\t\t\t<td>\r\n");
      out.write("\t\t\t\t");
      out.print(volunteerBoard.getVolunteerContent() );
      out.write("\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
...
if(memberLoggedIn != null&&
      ...
      out.write("\t\t<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerDelete\"\r\n");
      out.write("\t\t\tname=\"volunteerDeleteFrm\"\r\n");
      out.write("\t\t\tmethod=\"post\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"volunteerNo\" \r\n");
      out.write("\t\t\t\tvalue=\"");
      out.print(volunteerBoard.getVolunteerNo());
      out.write("\"/>\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"volunteerRenamedImg\"\r\n");
      out.write("\t\t\t\tvalue=\"");
      out.print(volunteerBoard.getVolunteerRenamedImg()!=null?volunteerBoard.getVolunteerRenamedImg():"");
      out.write("\"/>\r\n");
      out.write("\t\t</form>\r\n");
      out.write("\t\t<script>\r\n");
      ...
      out.write("\t\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerUpdate?volunteerNo=");
      out.print(volunteerBoard.getVolunteerNo());
      out.write("\";\r\n");
      out.write("\t\t}\r\n");
      ...
      out.write("\t\t\t\treturn;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t$(\"[name=volunteerDeleteFrm]\").submit();\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction goVolunteerList(){\r\n");
      out.write("\t\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerList\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t");
} 
      ...
      out.write("\t\t\t\tonclick=\"goVolunteerList();\" />\r\n");
      out.write("\t\r\n");
      out.write("<!--댓글 부분 -->\r\n");
      out.write("<hr style=\"margin-top: 30px;\"/>\r\n");
      out.write("<form action=\"");
      out.print(request.getContextPath());
      out.write("/board/volunteer/volunteerBoardCommentInsert\"\r\n");
