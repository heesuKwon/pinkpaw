 ...
 */
@WebServlet("/board/review/reviewBoardCommentInsert")
public class ReviewBoardCommentInsertServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("boardComment@ReviewBoardCommentInsertServlet="+boardComment);
		
		//2.업무로직
		int result = new ReviewCommentService().insertBoardComment(boardComment);
		
		//3.view단 처리
		String view = "/WEB-INF/views/common/msg.jsp";
		String msg = "";
		String loc = "/board/review/reviewView?reviewNo="+boardRef;
