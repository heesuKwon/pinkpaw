...
/**
 * Servlet implementation class volunteerWriteEndServlet
 */
@WebServlet("/board/volunteer/volunteerWriteEnd")
public class VolunteerWriteEndServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VolunteerWriteEndServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//2.업무로직
		int result = new VolunteerService().insertVolunteer(vb);
		System.out.println("result@VolunteerWriteServlet="+result);
		...
		if(result>0) {
			msg = "게시글 등록 성공!";
			loc = "/board/volunteer/volunteerView?volunteerNo="+result;
		} else {
			msg = "게시글 등록 실패!";
		}
