 ...
 * Generated at: 2019-08-18 17:41:22 UTC
...
public final class freeReport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	System.out.println("memberLoggedIn@index.jsp="+memberLoggedIn);
      ...
      out.print(request.getContextPath());
      out.write("/board/community/free/freeBoardReportEnd\" method=\"post\" >\r\n");
      out.write("\t\t\t<table>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th>작성자</th>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t<td>\t\r\n");
      out.write("\t\t\t\t\t\t<select name=\"freeReportContent\" id=\"freeReportContent\" onchange=\"change()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t<div id=\"freeOtherReason\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea name=\"freeOtherReason\" cols=\"40\" rows=\"5\" placeholder=\"내용을 입력해주세요.\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#freeOtherReason\").hide();\r\n");
      out.write("\t\t\t\t\t\t\tfunction change() {\r\n");
      out.write("\t\t\t\t\t\t\t\tvar state = $('#freeReportContent option:selected').val();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tif(state == \"기타\"){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#freeOtherReason\").show();\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#freeOtherReason\").hide();\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
