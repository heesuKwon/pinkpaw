 ...
 * Generated at: 2019-08-18 18:21:50 UTC
...
public final class missingReport_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	System.out.println("memberLoggedIn@index.jsp="+memberLoggedIn);
      ...
      out.write("\r\n");
      out.write("<div class=\"report-container\">\r\n");
      ...
      out.write("\t\t\t\t\t<th>작성자</th>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"reportWriter\" value=\"");
      ...
      out.write("\t\t\t\t\t<td>\t\r\n");
      out.write("\t\t\t\t\t\t<select name=\"missingReportContent\"  id=\"missingReportContent\" onchange=\"change()\">\r\n");
      ...
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t<div id=\"missingOtherReason\">\r\n");
      out.write("\t\t\t\t\t\t\t<textarea name=\"missingOtherReason\" cols=\"40\" rows=\"5\" placeholder=\"내용을 입력해주세요.\" ></textarea>\r\n");
      out.write("\t\t\t\t\t\t</div>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<script>\r\n");
      out.write("\t\t\t\t\t\t\t$(\"#missingOtherReason\").hide();\r\n");
      out.write("\t\t\t\t\t\t\tfunction change() {\r\n");
      out.write("\t\t\t\t\t\t\t\tvar state = $('#missingReportContent option:selected').val();\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\tif(state == \"기타\"){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#missingOtherReason\").show();\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\telse{\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#missingOtherReason\").hide();\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"2\" class=\"report-button\">\r\n");
